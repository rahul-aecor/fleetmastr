                ...
                <div class="modal-body">
                        ...
                        <div class="error-class mb-10">
                            <div class="row">
                                <div class="col-md-12">
                                    <label class="radio-default-overright font-sm">
                                        <input type="radio" name="update_pmi_schedule_edit" class="js-update-pmi-schedule-edit-radio" value="1">Yes, I would like to update all future scheduled PMI dates (next PMI on <span class='js-new-pmi-date-edit'></span>).
                                    </label>
                                </div>
                                <div class="col-md-12">
                                    <label class="radio-default-overright font-sm">
                                        <input type="radio" name="update_pmi_schedule_edit" class="js-update-pmi-schedule-edit-radio" value="0">No, please keep the scheduled dates as they are (next PMI on <span class='js-current-pmi-date-edit'></span>).
                                    </label>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="error-class mb-10">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <label class="radio-default-overright font-sm">
                                    <input type="radio" name="updateMOT" class="roles-types-radio" value="0" >No, please keep the schedule date as it is (next MOT due by <span id='motAsPerOld'></span>)
                                </label>
                            </div>
                        </div>
                    </div>
