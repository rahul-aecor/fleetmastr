    ...
    <tr>
        ...
        @if ($vehicle->type->service_interval_type == 'Distance')
            <td class="{{ $vehicle->next_service_inspection_distance ? displayExpiryNextInspectionForDistance($vehicle->last_odometer_reading, $vehicle->next_service_inspection_distance) : '' }}">
                {{ $vehicle->next_service_inspection_distance && floor($vehicle->next_service_inspection_distance) == $vehicle->next_service_inspection_distance ? number_format($vehicle->next_service_inspection_distance, 0) : '' }} {{ isset($vehicleNextDistanceEvent->event_plan_date) ? '('. $vehicleNextDistanceEvent->event_plan_date.')' : '' }}
