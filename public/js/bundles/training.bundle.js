...
module.exports = {
    ...
    methods: {
        contactClicked: function contactClicked(clickedContact) {
        ...
        updateContact: function updateContact(e) {
            e.preventDefault();
            this.validateForm();
            var _this = this;
            ...
            if (form.valid()) {
                // POST requests
                this.$http.put('/contacts/' + this.formContact.id, this.formContact).then(function (response) {
        ...
        saveNewContact: function saveNewContact() {
            ...
            if (form.valid()) {
                // POST requests
                this.$http.post('/contacts', this.formContact).then(function (response) {
                    _this.$set('clickedContact', {});
                    _this.$set('formContact', {});
                    _this.$dispatch('contact-list-changed');
        ...
        confirmDeleteContact: function confirmDeleteContact(e) {
            var _this = this;
            e.preventDefault();
            bootbox.confirm({
                title: "Confirmation",
        ...
        deleteContact: function deleteContact(e) {
            var _this = this;
            // POST requests
            this.$http['delete']('/contacts/' + this.formContact.id).then(function (response) {
                _this.$set('clickedContact', {});
                _this.$set('formContact', {});
                _this.$dispatch('contact-list-changed');
...
},{"./template.html":13,"lodash":1}],13:[function(require,module,exports){
module.exports = '<div class="row">\n    <div class="col-md-4">\n        <label class="control-label">\n            Saved contacts \n        </label>\n        <ul class="ver-inline-menu acco_info tabbable margin-bottom-10 scroller" data-height="600px">            \n                <li v-for="contact in contacts | orderBy \'name\'" v-on:click="contactClicked(contact)">\n                    <a data-toggle="tab" href="#" aria-expanded="false">\n                    <i class="jv-icon jv-user"></i> {{ contact.name }}</a>\n                    <span class="after">\n                    </span>\n                </li>\n        </ul>\n    </div>\n    <div class="col-md-6 col-md-offset-1">\n        <form action="#" class="horizontal-form" id="contact-form">\n            <div class="form-body">\n                <div class="row">\n                    <div class="col-md-12">\n                        <div class="form-group has-feedback">\n                            <label class="control-label">\n                                Name\n                            </label>\n                            <input type="hidden" name="id" class="form-control" placeholder="" v-model="formContact.id">\n                            <div class="input-icon right">\n                                <input type="text" name="name" \n                                    class="form-control" \n                                    placeholder="Enter new contact name" \n                                    v-model="formContact.name">\n                            </div>\n                        </div>\n                    </div>\n                </div>\n                <div class="row">\n                    <div class="col-md-12">\n                        <div class="form-group">\n                            <label class="control-label">\n                                Mobile\n                            </label>\n                            <input type="text" name="mobile" \n                                class="form-control" \n                                placeholder="Enter mobile number e.g. format 07977100100" \n                                v-model="formContact.mobile">\n                        </div>\n                    </div>\n                </div>\n                <div class="row">\n                    <div class="col-md-12">\n                        <div class="form-group">\n                            <label class="control-label">\n                                Company\n                            </label>\n                            <input type="text" name="company" \n                                class="form-control" \n                                placeholder="Enter company name" \n                                v-model="formContact.company">\n                        </div>\n                    </div>\n                </div>\n                <div class="row">\n                    <div class="col-md-12">\n                        <div class="form-group">\n                            <label class="control-label">\n                                Email\n                            </label>\n                            <input type="text" \n                                name="email" \n                                id="email" \n                                class="form-control" \n                                placeholder="Enter contact email" \n                                v-model="formContact.email">\n                        </div>\n                    </div>\n                </div>\n            </div>\n            <div class="form-actions">\n                <div class="btn-group col-md-12 padding0">\n                    <button type="button" class="btn red-rubine btn-padding col-md-4"\n                        v-on:click="updateContact"\n                        v-show="typeof formContact.id !== \'undefined\'">\n                        Update\n                    </button>\n                    <button type="button" \n                        class="btn red-rubine btn-padding col-md-4"\n                        v-on:click="saveNewContact"\n                        v-show="typeof formContact.id === \'undefined\'">\n                        Add\n                    </button>\n                    <button type="button" \n                        class="btn white-btn btn-padding col-md-4"\n                        v-on:click="resetContactForm">\n                        Clear\n                    </button>\n                    <button type="button" \n                        class="btn white-btn btn-padding col-md-4"\n                        v-on:click="confirmDeleteContact"\n                        v-show="typeof formContact.id !== \'undefined\'">\n                        Delete\n                    </button>\n                </div>\n            </div>\n        </form>            \n    </div>\n</div> ';
...
module.exports = {
    ...
    ready: function ready() {},
    methods: {
        contactCheckboxClicked: function contactCheckboxClicked(contact) {
            var matches = u.find(this.group.contacts, { 'id': this.contact.id }, 'id');
...
},{"./template.html":15,"lodash":1}],15:[function(require,module,exports){
module.exports = '<div class="checkbox-list">\n    <label>\n        <div class="checker">\n            <span v-bind:class="checked" v-on:click="contactCheckboxClicked(contact)"><input type="checkbox" name="contactCheckbox"></span>\n        </div> \n        {{ contact.name }}\n        <span v-show="contact.email">(<a class="font-blue" v-bind:href="\'mailto:\' + contact.email">{{ contact.email }}</a>)</span>\n    </label>\n</div>';
...
module.exports = {
    ...
    computed: {
        ...
        setDisabledClass: function setDisabledClass() {
    ...
    ready: function ready() {},
    methods: {
        siteContactCheckboxClicked: function siteContactCheckboxClicked(siteContact) {
            var matches = u.find(this.group.users, { 'id': this.siteContact.id }, 'id');
            if (typeof matches !== 'undefined') {
...
},{"./template.html":17,"lodash":1}],17:[function(require,module,exports){
module.exports = '\n<div class="checkbox-list">\n    <label>\n        <div class="checker" :class="setDisabledClass">\n            <span v-bind:class="checked" v-on:click="siteContactCheckboxClicked(siteContact)">\n            	<input type="checkbox" name="siteContactCheckbox" :disabled="disabled">\n            </span>\n        </div> \n        {{ siteContact.first_name }} {{ siteContact.last_name }} \n        (<a class="font-blue" v-bind:href="\'mailto:\' + siteContact.email">{{ siteContact.email }}</a>) \n        <span v-if="siteContact.is_app_installed==1"> <i class="fa fa-mobile"></i></span>\n    </label>\n</div>    ';
...
module.exports = {
    ...
    computed: {
        'eligibleSiteContacts': function eligibleSiteContacts() {
        ...
        numofGroupUsers: function numofGroupUsers() {
            return typeof this.formGroup.users !== 'undefined' ? this.formGroup.users.length : 0;
        },
        numofGroupContacts: function numofGroupContacts() {
    ...
    methods: {
        groupClicked: function groupClicked(clickedGroup) {
            // remove error classes if any
        ...
        updateGroup: function updateGroup(e) {
            ...
            if (form.valid()) {
                // POST requests
                this.$http.put('/groups/' + this.formGroup.id, this.formGroup).then(function (response) {
        ...
        saveNewGroup: function saveNewGroup() {
            this.validateForm();
            var _this = this;
            var form = $("#group-form");
            if (form.valid()) {
                // POST requests
                this.$http.post('/groups', this.formGroup).then(function (response) {
                    _this.$set('clickedGroup', {});
                    _this.$set('formGroup', {});
                    _this.$dispatch('group-list-changed');
        ...
        confirmDeleteGroup: function confirmDeleteGroup(e) {
            var _this = this;
            e.preventDefault();
            bootbox.confirm({
                title: "Confirmation",
        ...
        deleteGroup: function deleteGroup(e) {
            var _this = this;
            // POST requests
            this.$http['delete']('/groups/' + this.formGroup.id).then(function (response) {
                _this.$set('clickedGroup', {});
                _this.$set('formGroup', {});
                _this.$dispatch('group-list-changed');
        ...
        checkAllContacts: function checkAllContacts() {
        ...
        checkAllSiteContacts: function checkAllSiteContacts() {
...
module.exports = {
    ...
    computed: {
        ...
        'eligibleGroups': function eligibleGroups() {
            if (this.message.template.type !== 'standard') {
        ...
        messageHasRecepients: function messageHasRecepients() {
            return this.message.numbers.length || this.message.template.users.length || this.message.template.groups.length;
        },
        numofMessageUsers: function numofMessageUsers() {
            return typeof this.message.template.users !== 'undefined' ? this.message.template.users.length : 0;
        },
        numofMessageGroups: function numofMessageGroups() {
    ...
    methods: {
        templateSelected: function templateSelected(selectedTemplate) {
            // remove error classes if any
        ...
        templateTypeChanged: function templateTypeChanged() {
            this.$set('allUsersChecked', false);
        ...
        showSendMessageConfirmation: function showSendMessageConfirmation(event) {
        ...
        checkAllGroups: function checkAllGroups() {
...
module.exports = {
    ...
    computed: {
        ...
        messageTitleValidation: function messageTitleValidation() {
...
module.exports = '<label class="control-label">\n    {{ name }} (Multiple choice)\n</label>               \n<div v-for="(choiceIndex, choice) in questions">\n    <dl>\n        <dt>{{ choiceIndex + 1 }}. {{{ choice.question }}}</dt>\n        <ul class="list-unstyled">\n            <li v-for="(answerIndex, answer) in choice.answers">\n                <i class="fa fa-angle-right"></i> {{ answer.text }}\n            </li>\n        </ul>\n    </dl>\n</div>';
...
module.exports = {
    ...
    ready: function ready() {},
    methods: {
        addAnswerClicked: function addAnswerClicked(questionIndex) {
            this.questions[questionIndex]['answers'].push({ 'is_correct': false, 'text': '' });
            this.$nextTick(function () {
                Metronic.initAjax();
            });
        },
        deleteAnswerClicked: function deleteAnswerClicked(questionIndex, answerIndex) {
            this.questions[questionIndex]['answers'].splice(answerIndex, 1);
        },
        addQuestionClicked: function addQuestionClicked() {
            this.questions.push({
                "question": "",
                "answers": [{
                    "text": "",
        ...
        deleteQuestionClicked: function deleteQuestionClicked(questionIndex) {
            this.questions.splice(questionIndex, 1);
        },
        answerChecked: function answerChecked(questionIndex, answerIndex) {
...
},{"../template-form/directives/editor":36,"./template.html":27}],27:[function(require,module,exports){
...
module.exports = '<label class="control-label">\n    {{ name }} (Q & A survey)\n</label>       \n<dl>\n    <dt v-for="(choiceIndex, choice) in questions">\n        {{ choiceIndex + 1 }}. {{{ choice.text }}}\n    </dt>\n</dl>';
...
},{"../template-form/directives/editor":36,"./template.html":31}],31:[function(require,module,exports){
module.exports = '<label class="control-label">\n    <span>Q&A survey</span> <span class="font-grey-silver">(enter at least one question)</span>\n</label>  \n<div v-for="(choiceIndex, choice) in questions">\n    <div class="form-group">\n        <label class="control-label">\n            Question {{ choiceIndex + 1 }}\n        </label>\n        <a href="javascript:void(0)" \n            class="font-pink add-answer-link pull-right underline" \n            v-show="choiceIndex > 0"\n            v-on:click="deleteQuestionClicked(choiceIndex)">\n            Remove question\n        </a>\n        <input class="form-control inline-rich-editor"\n            v-bind:name="\'openChoiceEditor\' + choiceIndex"\n            v-bind:id="\'openChoiceEditor\' + choiceIndex"            \n            v-editor="choice.text"\n            data-rule-required="true"\n            v-model="choice.text" /> \n    </div>\n</div>\n<p class="next_que"><button type="button" class="btn red-rubine" v-on:click="addQuestionClicked()">Add next question</button></p>';
...
module.exports = {
    ...
    computed: {
        ...
        totalRecipientsInGroup: function totalRecipientsInGroup() {
            return this.group.users.length;
        }
    },
    ready: function ready() {},
    methods: {
        groupCheckboxClicked: function groupCheckboxClicked(group) {
            var matches = u.find(this.template.groups, { 'id': this.group.id }, 'id');
            if (typeof matches !== 'undefined') {
...
},{"./template.html":35,"lodash":1}],35:[function(require,module,exports){
module.exports = '<div class="checkbox-list group-name">\n    <label>\n        <div class="checker">\n            <span v-bind:class="checked" v-on:click="groupCheckboxClicked(group)"><input type="checkbox" name="groupCheckbox"></span>\n        </div> \n        {{ group.name }} <span>({{ totalRecipientsInGroup }})</span>\n    </label>\n</div>';
...
module.exports = {
    ...
    bind: function bind() {
        var _this = this;
        // $(_this.el).rules('add', 'required');
        // tinymce.remove('#' + _this.params.id);
        setTimeout(function () {
            var inp;
            var filetype = "image";
            tinymce.init({
                ...
                resize: true,
                elementpath: false,
                plugins: 'link image media, placeholder, media',
                ...
                setup: function setup(editor) {
                    ...
                    //inp = $('<input class="custom-tinymce-file-upload" id="tinymce-uploader' + _this.params.id + '" type="file" name="pic' + _this.params.id + '" accept="video/mp4,video/x-m4v,video/*,image/*" style="display:none">');
                    if (!$("div#questionUpload").length) {
                        ...
                        flow.assignBrowse($('#questionUpload')[0]);
                        ...
                        flow.on('filesSubmitted', function (file) {
                            ...
                            if (isSuccess) {
                                ...
                                toastr["error"]("Please select JPG and PNG image only.");
                            }
                        });
                        ...
                        flow.on('fileSuccess', function (file, message) {
                            ...
                            $('#videoProcessingModal .progress-bar').css('width', '0').attr('aria-valuenow', 0).text('0%');
                            window.testCallback(response.url, { alt: '' });
                        });

                        flow.on('progress', function () {
                            var currentProgress = Math.floor(flow.progress() * 100);
                            $('#videoProcessingModal .progress-bar').css('width', currentProgress + '%').attr('aria-valuenow', currentProgress).text(currentProgress + '%');
                        });
                    } else {
...
module.exports = {
    ...
    props: ['contacts', 'groups', 'siteContacts', 'templates'],
    components: {
        contactcheckbox: contactcheckbox,
        sitecontactcheckbox: sitecontactcheckbox,
        groupcheckbox: groupcheckbox,
    ...
    data: function data() {
        return {
            ...
            templateTypeoptions: [{ id: 'standard', text: 'Standard message' }, { id: 'multiple_choice', text: 'Multiple choice questionnaire' }, { id: 'survey', text: 'Q&A survey' }],
            departmentOptions: [{ 'id': 'Human Resources', 'text': 'Human Resources' }, { 'id': 'General Management', 'text': 'General Management' }, { 'id': 'Transport Management', 'text': 'Transport Management' }, { 'id': 'Health and Safety', 'text': 'Health and Safety' }, { 'id': 'Compliance', 'text': 'Compliance' }, { 'id': 'Finance', 'text': 'Finance' }],
            clickedTemplate: {},
            formTemplate: {
                "name": "",
                "content": "",
    ...
    computed: {
        ...
        // },
        numofTemplateUsers: function numofTemplateUsers() {
        ...
        // },
        numofTemplateGroups: function numofTemplateGroups() {
            return typeof this.formTemplate.groups !== 'undefined' ? this.formTemplate.groups.length : 0;
        },
        departmentOptionsSorted: function departmentOptionsSorted() {
            return u.sortBy(this.departmentOptions, function (department) {
                return department.text.toLowerCase();
            });
        }
    },
    // dom ready
    ready: function ready() {
        ...
        $('#department').select2({
            data: this.departmentOptionsSorted,
            allowClear: true
        });
    ...
    methods: {
        templateClicked: function templateClicked(clickedTemplate) {
            // remove error classes if any
        ...
        updateTemplate: function updateTemplate(e) {
            ...
            if (form.valid()) {
                // POST requests
                this.$http.put('/templates/' + this.formTemplate.id, this.formTemplate).then(function (response) {
        ...
        saveNewTemplate: function saveNewTemplate() {
            ...
            if (form.valid()) {
                // POST requests
                this.$http.post('/templates', this.formTemplate).then(function (response) {
                    // _this.$set('clickedTemplate', {});
                    // _this.$set('formTemplate', {});
                    _this.resetTemplateForm();
                    _this.$dispatch('template-list-changed');
        ...
        confirmDeleteTemplate: function confirmDeleteTemplate(e) {
            var _this = this;
            e.preventDefault();
            bootbox.confirm({
                title: "Confirmation",
        ...
        deleteTemplate: function deleteTemplate() {
            var _this = this;
            // POST requests
            this.$http['delete']('/templates/' + this.formTemplate.id).then(function (response) {
                _this.resetTemplateForm();
                _this.$dispatch('template-list-changed');
        ...
        validateForm: function validateForm() {
            return $('#template-form').validate({
                ...
                unhighlight: function unhighlight(element) {// revert the change done by hightlight
                    // $(element)
...
new Vue({
    ...
    // vue methods
    events: {
        'group-list-changed': function groupListChanged() {
            this.getGroups();
        },
        'template-list-changed': function templateListChanged() {
            this.getTemplates();
        },
        'message-list-changed': function messageListChanged() {
            this.getPaginatedMessages();
        }
    },
    methods: {
        getSiteContacts: function getSiteContacts() {
        ...
        getPaginatedMessages: function getPaginatedMessages(direction) {
            var data = {
                paginate: this.pagination.per_page,
                page: this.pagination.current_page
            };
            var _this = this;
            this.$http.get('/messages/paginate', data).then(function (response) {
...
},{"./components/contact-form":12,"./components/group-form":18,"./components/message-form":20,"./components/messages-form":22,"./components/template-form":37,"./filters/date-formatter":39,"lodash":1,"vue":11,"vue-resource":4}]},{},[40]);
