...
new Vue({
    ...
    data: {
        ...
        defectTrailerAttached: [{ id: 0, 'text': 'No' }, { id: 1, 'text': 'Yes' }],
    ...
    events: {
        'edit-defect-clicked': function editDefectClicked(defect, defectCategory) {
        ...
        'remove-defect-clicked': function removeDefectClicked(defect) {
            this.$set('selectedDefect', defect);
        ...
        'existing-defect-clicked': function existingDefectClicked(defect, defectCategory) {
            this.$nextTick(function () {
    ...
    // vue methods
    methods: {
        verifyOdometer: function verifyOdometer() {
        ...
        fetchSurveyJson: function fetchSurveyJson(surveyMasterId) {
            var trailerValue = this;
        ...
        confirmVehicleDetails: function confirmVehicleDetails() {
            this.$set('currentStep', 3);
            // API CALL to fetch the survey JSON          
        },
        defectCustomUploadClicked: function defectCustomUploadClicked(index) {
            $('.image-upload-btn-' + index).trigger('click');
        },
        handleImageChange: function handleImageChange(updatedDefect, event, index) {
        ...
        bindPlugins: function bindPlugins() {
            var validateValue = this;
        ...
        fixForForms: function fixForForms() {
        ...
        imageMan: function imageMan(index) {
            var $image = $('.image-' + index);
            $image.cropper(this.cropperOptions);
        },
        rotateImage: function rotateImage(rotateData, index) {
            var $image = $('.image-' + index);
        ...
        createDefect: function createDefect() {
            var _this = this;

            // API call for image upload
            if (this.selectedDefect._image != "no") {
                this.imageData = u.reject(this.imageData, function (o) {
                    return o.imageString === '';
                });
                this.imageData.forEach(function (image, index) {
                    var $image = $('.image-' + index);
                    if (image.imageString && image.imageString !== "" && $image.data('cropper')) {
                        _this.$set('uploadImageInProgress', true);
                        var imageCropData = $image.cropper('getCroppedCanvas').toDataURL();
                        _this.uploadImage(imageCropData, index);
                        $('.image-upload-btn-' + index).val(null);
                    }
                });
            } else {
        ...
        createDefectWithoutImage: function createDefectWithoutImage() {
        ...
        changeVehicleStatusAndCreate: function changeVehicleStatusAndCreate(status) {
            NProgress.start();
        ...
        uploadImage: function uploadImage(result, index) {
            var $image = $('.image-' + index);
            ...
            this.$http.post('imaged/upload', {
                ...
                'image_exif': moment().format("HH:mm:SS D MMM YYYY") + ',0.0;-0.0'
            }).success(function (response) {
                var obj = {};
        ...
        noDefectSelected: function noDefectSelected() {
            this.$set('updatedDefect.selected', 'no');
            this.$set('updatedDefect.imageString', '');
        },
        showExistingDefects: function showExistingDefects() {
            this.$dispatch('existing-defect-clicked');
        },

        defectCancelButton: function defectCancelButton() {
            window.location.href = Site.appUrl;
        },

        trailerIdCheckValidation: function trailerIdCheckValidation() {
            var checkString = this.form.trailer_reference_number;
...
},{"./components/checks-create/check-type-list":13,"./components/checks-create/existing-defect-list":15,"./filters/check-status-formatter":17,"lodash":1,"vue":11,"vue-resource":4}],13:[function(require,module,exports){
'use strict';
...
module.exports = {
    ...
    methods: {
        handleEditDefect: function handleEditDefect(defect, defectCategory) {
            this.$dispatch('edit-defect-clicked', defect, defectCategory);
        },
        handleRemoveDefect: function handleRemoveDefect(defect) {
            this.$dispatch('remove-defect-clicked', defect);
        },
        getTitleClass: function getTitleClass(option) {
...
module.exports = '<!-- <div class="portlet light bordered check-info-portlet col-md-8 col-md-offset-2" v-if="selectedVehicleInformation.hasDefects">\n    <div class="portlet-title">        \n        <div class="caption">\n            <i class="fa fa-chevron-circle-right font-pure-red"></i>\n            <span class="caption-subject font-pure-red bold">  &nbsp;This vehicle has defects</span>\n        </div>\n        <div class="tools">\n            <a href="javascript:;" class="expand">\n            </a>            \n        </div>\n    </div>\n    <div class="portlet-body clearfix" style="display: none;">\n        <div class="portlet light existing-defect-list-section" v-for="defectCategory in selectedVehicleInformation.defects.defects_list">\n            <div class="portlet-body">\n                <p class="bold font-red-rubine">                \n                    {{ defectCategory.defects_title }}\n                </p>\n                <p v-for="defect in defectCategory.added_defects">\n                     <i class="fa fa-close font-pure-red"></i> &nbsp; \n                    {{ defect.text }}\n                </p>\n            </div>            \n        </div>        \n    </div>\n</div> -->\n\n<div class="modal default-modal modal-scroll fade" tabindex="-1" role="dialog" id="existing-defect-modal" data-backdrop="static" data-keyboard="false" v-if="selectedVehicleInformation.hasDefects">\n    <div class="modal-dialog">\n        <div class="modal-content">\n            <div class="modal-header bg-red-rubine d-flex align-items-center justify-content-between">\n                <h4 class="modal-title">Existing Vehicle Defects</h4>\n                <a class="font-red-rubine" data-dismiss="modal" aria-label="Close">\n                    <i class="jv-icon jv-close"></i>\n                </a>\n            </div>\n\n            <div class="modal-body">\n                <div class="portlet light existing-defect-list-section padding-top-5 padding-bottom-5" v-for="defectCategory in selectedVehicleInformation.defects.defects_list">\n                    <div class="portlet-body">\n                        <p class="bold font-red-rubine">                \n                            {{ defectCategory.defects_title }}\n                        </p>\n                        <p v-for="defect in defectCategory.added_defects">\n                             <i class="fa fa-close font-pure-red"></i> &nbsp; \n                            {{ defect.text }}\n                        </p>\n                    </div>            \n                </div> \n            </div>\n        </div>\n    </div>\n</div>';
...
//# sourceMappingURL=checks-create.bundle.js.map
